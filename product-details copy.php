   ...
   <div class="container">
                  ...
                  <div class="row">
                     <div class="col-sm-3 col-lg-3">
                        <div class="owl-thumbs" data-slider-id="1">
                           <div class="item owl-thumb-item active">
                              <div class="top-img">
                     ...
                     <div class="col-sm-9 col-lg-9">
                        <div class="image-slides owl-carousel owl-theme owl-loaded owl-drag" data-slider-id="1">
                           <div class="owl-stage-outer">
                              <div class="owl-stage" style="transform: translate3d(-1111px, 0px, 0px); transition: all; width: 3892px;">
                                 <div class="owl-item cloned" style="width: 555.984px;">
                                    <div class="top-img">
                                       <img src="assets/images/slider-2.jpg" alt="Product">
                                    </div>
                                 </div>
                                 <div class="owl-item cloned" style="width: 555.984px;">
                                    <div class="top-img">
                                       <img src="assets/images/slider-3.jpg" alt="Product">
                                    </div>
                                 </div>
                                 <div class="owl-item active" style="width: 555.984px;">
                                    <div class="item">
                                       <div class="top-img">
                                          <img src="assets/images/slider-4.jpg" alt="Product">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="owl-item" style="width: 555.984px;">
                                    <div class="top-img">
                                       <img src="assets/images/slider-2.jpg" alt="Product">
                                    </div>
                                 </div>
                           ...
                           <div class="owl-nav disabled"><button type="button" role="presentation" class="owl-prev"><i class="bx bx-chevron-left" aria-hidden="true"></i></button><button type="button" role="presentation" class="owl-next"><i class="bx bx-chevron-right" aria-hidden="true"></i></button></div>
      ...
      <div class="bottom">
         <ul class="nav nav-pills" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
               <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false" tabindex="-1">Reviews</a>
            </li>
            <li class="nav-item" role="presentation">
            </li>
         </ul>
