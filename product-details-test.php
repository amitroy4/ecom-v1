         ...
         <div class="row align-items-center mt-4 mb-4">
            ...
            <div class="col-lg-6">
               <div class="top-content">
                  ...
                  <ul>
                     <div class="attr-detail attr-color mt-20 mb-20">
                        ...
                        <ul class="list-filter color-filter">
                           <li>
                              <a href="#" class="color-option bg-black">
                                 <span class=""></span>
                              </a>
                              <p class="color-stock-preview position-absolute" style="font-size: 12px;">11 Items Left
                              </p>
                           </li>
                           <li>
                              <a href="#" class="color-option bg-primary">
                                 <span class=""></span>
                              </a>
                           ...
                           <li>
                              <a href="#" class="color-option bg-secondary">
                                 <span class=""></span>
                              </a>
                              <p class="color-stock-preview position-absolute" style="font-size: 12px; display:none;">11
                                 Items Left</p>
                           ...
                           <li>
                              <a href="#" class="color-option bg-info">
                                 <span class=""></span>
                              </a>
                              <p class="color-stock-preview position-absolute" style="font-size: 12px; display:none;">11
                                 Items Left</p>
                  ...
                  <ul>
                     <div class="attr-detail attr-size mt-4 mb-4">
                        ...
                        <ul class="list-filter size-filter font-small" id="sizeOptions" wire:ignore="">
                           <li class="active" wire:ignore="">
                              <a href="#" class="size-option" data-size="S" wire:click="itemSize(40)">
                                 <span>S</span>
                              </a>
                           ...
                           <li class="active" wire:ignore="">
                              <a href="#" class="size-option" data-size="M" wire:click="itemSize(41)">
                                 <span>M</span>
                              </a>
                              <p wire:ignore="" class="size-stock-preview position-absolute"
                                 style="display: none; font-size: 12px;"> 2 Items</p>
                           ...
                           <li class="" wire:ignore="">
                              <a href="#" class="size-option" data-size="L" wire:click="itemSize(42)">
                                 <span>L</span>
                              </a>
                              <p wire:ignore="" class="size-stock-preview position-absolute"
                           ...
                           <li class="" wire:ignore="">
                              <a href="#" class="size-option" data-size="XL"  wire:click="itemSize(43)">
                                 <span>XL</span>
                              </a>
                              <p wire:ignore="" class="size-stock-preview position-absolute"
                           ...
                           <li class="" wire:ignore="">
                              <a href="#" class="size-option" data-size="XXL"  wire:click="itemSize(43)">
                                 <span>XXL</span>
                              </a>
                              <p wire:ignore="" class="size-stock-preview position-absolute"
                                 style="display: none; font-size: 12px;"> 0 Items</p>
                           ...
                           <li class="" wire:ignore="">
                              <a href="#" class="size-option" data-size="XXXL" wire:click="itemSize(43)">
                                 <span>XXXL</span>
                              </a>
                              <p wire:ignore="" class="size-stock-preview position-absolute"
                                 style="display: none; font-size: 12px;"> 0 Items</p>
                  ...
                  <ul class=" tag text-grey-5 mt-20 d-flex text-items-center">
                     ...
                     <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                        ...
                        <div class="row">
                           <div class="col-12 d-flex">
                              <div class="col-4"><img src="assets/images/p4.avif" alt="Image" style="width: 200px;">
                              </div>
                                    ...
                                    <div>
                                       <div class="attr-detail attr-size mt-4">
                                          ...
                                          <ul class="list-filter size-filter font-small" id="sizeOptions"
                                             wire:ignore="">
                                             <li class="active" wire:ignore="">
                                                <div href="#" class="size-option" data-size="XL"
                                             ...
                                             <li class="" wire:ignore="">
                                                <div href="#" class="size-option" data-size="XXL"
                                                   wire:click="itemSize(41)">
                                                   <span>XXL</span>
                                                </div>
                                                <p wire:ignore="" class="size-stock-preview position-absolute"
                                                   style="display: none; font-size: 12px;"> 2 Items</p>
                                             ...
                                             <li class="" wire:ignore="">
                                                <div href="#" class="size-option" data-size="XXXL"
                                                   wire:click="itemSize(42)">
                                                   <span>XXXL</span>
                                                </div>
                                                <p wire:ignore="" class="size-stock-preview position-absolute"
                                                   style="display: none; font-size: 12px;"> 4 Items</p>
                                             </li>
                                             <li class="disabled" wire:ignore="">
                                                <div href="#" class="size-option" data-size="XS" disabled=""
